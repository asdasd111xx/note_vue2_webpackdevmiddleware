    ...
    <div class="first-friends-table">
        <div class="thead">
            <div class="row clearfix">
                ...
                <!-- 狀態 -->
                <div class="column status">{{ $text('S_STATUS') }}</div>
                <!-- 主帳戶餘額 -->
                <div class="column balance">{{ $text('S_MAIN_BALANCE') }}</div>
            </div>
        </div>
        <div v-if="firstFriends.length" class="tbody">
            <template v-for="(info, index) in firstFriends">
                ...
                >
                    ...
                    <div class="column balance">
                        ...
                        <span :class="['icon-info', {active: subInfoIndex === index}]" />
                    </div>
                    <!-- 詳細資料 -->
        ...
        <div v-if="!firstFriends.length" class="tbody">
            <div class="no-data">{{ $text('S_NO_FIRST_FRIEND_DATA') }}</div>
        </div>
    </div>
</template>
