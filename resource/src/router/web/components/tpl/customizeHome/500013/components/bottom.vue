            ...
            <div :class="$style['qrcode-container']">
                <div :class="$style['qrcode-img']">
                    ...
                    <div @click="openMobileBet">
                        <img src="/static/image/tpl/customizeHome/500013/body/qrcode_text.png" />
                    </div>
                </div>
                <div :class="$style['qrcode-img']">
                    <img :class="$style.qrcode" :src="mobileBetImage" />
        ...
        <div :class="$style['copy-wrap']">
            <div :class="$style['copy-container']">
                <div :class="$style['copy-text']">
                    <img src="/static/image/tpl/customizeHome/500013/body/footer_info.png" />
                </div>
                <div :class="$style['copy-info']">
                    <img :class="$style['copy-info-title']" src="/static/image/tpl/customizeHome/500013/body/footer_info_title01.png" />
                    <img :class="$style['img-bbin']" src="/static/image/tpl/customizeHome/500013/body/bbin.png" />
                    <img :class="$style['img-gli']" src="/static/image/tpl/customizeHome/500013/body/gli.png" />
                </div>
                <div :class="$style['copy-info']">
                    <img :class="$style['copy-info-title']" src="/static/image/tpl/customizeHome/500013/body/footer_info_title02.png" />
                    <img :class="$style['img-payment']" src="/static/image/tpl/customizeHome/500013/body/footer_info_payment.png" />
                </div>
            </div>
        </div>
    </div>
    ...
    computed: {
        ...
        linkArr() {
            ...
            Object.keys(this.pageData).forEach((page) => {
                if (page === '38488' || page === '10313' || page === '13691') { // 公司簡介
                    linkList.company = {
                        ...this.pageData[page],
                ...
                if (page === '38486' || page === '10371' || page === '13699') { // 聯絡我們
                    linkList.contact = {
                        ...this.pageData[page],
                ...
                if (page === '38484' || page === '10306' || page === '13700') { // 合作夥伴
                    linkList.partner = {
                        ...this.pageData[page],
                ...
                if (page === '38489' || page === '10315' || page === '13701') { // 存款幫助
                    linkList.deposit = {
                        ...this.pageData[page],
                ...
                if (page === '38490' || page === '10319' || page === '13702') { // 取款幫助
                    linkList.withdraw = {
                        ...this.pageData[page],
                ...
                if (page === '38491' || page === '10320' || page === '13703') { // 常見問題
                    linkList.question = {
                        ...this.pageData[page],
                ...
                if (page === '38492' || page === '10323' || page === '13704') { // 條款與細則
                    linkList.terms = {
                        ...this.pageData[page],
