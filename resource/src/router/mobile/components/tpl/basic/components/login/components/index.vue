<template>
    <div class="login-form-wrap clearfix">
        ...
        <span class="login-unit login-unit-link">
            ...
            &#183;<router-link to="/mobile/joinmember">{{ $t('S_JOIN_MEMBER') }}</router-link>
        </span>
        <!-- 登入鈕 -->
        ...
        <div class="login-btn-wrap clearfix">
            <router-link
                ...
                :class="['join-agent-link', { only: $route.name === 'agLogin' || !memInfo.config.agent_login }]"
                to="/mobile/joinagent"
            >
                {{ $t('S_CEP_JOINAGENT') }}
            </router-link>
            <router-link
                ...
                :class="['agent-login-link', { 'is-block': !memInfo.config.agent_register }]"
                to="/mobile/aglogin"
            >
                {{ $t('S_AGENT_LOGIN') }}
            </router-link>
