...
// 取得熱門遊戲(廳主推薦)模塊清單
export const API_GET_CUSTOMIZED_HOT_GAME =
  "/api/v1/c/vendor/all/recommend/games";
...
// 會員中心-帳戶資料欄位開關
export const API_MCENTER_USER_CONFIG =
  "/api/v1/c/player/user_info_config/with_verify";
...
// 忘記密碼手機簡訊
export const API_PWD_MOBILE_VERIFY =
  "/api/v1/c/player/forget/password/sms/verify";
...
// 下層好友總覽
export const API_MANAGEMENT_FRIENDS_STATISTICS =
  "/api/v1/c/stats/player/friends/overview";

// 一級好友今日登入、今日註冊、今日有投注、今日存款會員、7日未登入數量
export const API_MANAGEMENT_FIRST_LEVEL_INFO =
  "/api/v1/c/stats/player/depth/1/friends";

// 各級好友總人數、新增會員數、存款會員數、取款會員數
export const API_MANAGEMENT_LEVEL_LIST =
  "/api/v1/c/stats/player/friends/trans_report";
...
// 一級好友注單統計資料
export const API_FRIEND_WAGER_REPORT =
  "/api/v1/c/stats/player/friends/wager_report";

// 取得使用者每日各遊戲的注單統計資料
export const API_FRIEND_WAGER_REPORT_BY_DAY_GAME =
  "api/v1/c/stats/player/friend/wager_report/by_day_game";

// 會員依遊戲類別取得下層注單一覽
export const API_FRIEND_RECORD_DETAIL =
  "/api/v1/c/friend/wagers/list_by_game_code";
...
// 代理中心 - 帳戶資料欄位開關
export const API_AGENT_USER_CONFIG =
  "/api/v1/c/agent/user_info_config/with_verify";
...
// 忘記密碼手機簡訊
export const API_AGENT_PWD_FORGET_MOBILE =
  "/api/v1/c/agent/forget/password/sms";

// 忘記密碼手機簡訊
export const API_AGENT_PWD_MOBILE_VERIFY =
  "/api/v1/c/agent/forget/password/sms/verify";
...
// 會員存款總額
export const API_MCENTER_DESPOSIT_AMOUNT =
  "/api/v1/c/stats/player/deposit_amount";
...
// 投注記錄
export const API_MCENTER_BETRECORD_TOTAL = "/api/v1/c/stats/player/bet";
export const API_MCENTER_BETRECORD_ALL = "/api/v1/c/wagers/list_by_vendor";
export const API_MCENTER_BETRECORD_GAMECODE =
  "/api/v1/c/wagers/list_by_game_code";
...
// 會員中心存款 (登入前)
export const API_MCENTER_DEPOSIT_BEFORE_LOGIN =
  "/api/v1/c/link/deposit_before_login";
// 會員中心存款
export const API_MCENTER_DEPOSIT = "/api/v1/c/link/deposit";
// 會員中心存款第三方
export const API_MCENTER_DEPOSIT_THIRD = "/api/v2/c/links";
// 會員中心新的存款
export const API_MCENTER_DEPOSIT_INPAY =
  "/api/v1/c/ext/inpay?api_uri=/api/trade/v2/c/vendor_user_level/payment_group";
// 會員中心 - 存款支付通道
...
// 會員中心 - 存款取得單筆紀錄
export const API_MCENTER_DEPOSIT_SINGLE =
  "/api/v1/c/ext/inpay?api_uri=/api/trade/v2/c/entry";
// 會員中心 - 迅付中繼
...
// 會員中心 - 取款 - 取得會員帳戶
export const API_MCENTER_WITHDRAW =
  "/api/v1/c/ext/inpay?api_uri=/api/trade/v2/c/withdraw/user/account/list";
// 會員中心 - 取款 - 一鍵歸戶
...
export const API_AGCENTER_RECORD =
  "/api/v1/c/stats/agent/children/wager_report";
// 會員遊戲紀錄 (內層-依會員+指定平台)
export const API_AGCENTER_RECORD_MEMBER =
  "/api/v1/c/stats/player/vendors/kinds/wager_report";
// 會員遊戲紀錄 (內層-依會員+指定平台+遊戲類別)
export const API_AGCENTER_RECORD_DETIAL =
  "/api/v1/c/child/wagers/list_by_game_code";
