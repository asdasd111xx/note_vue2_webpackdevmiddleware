...
export const SET_NOTMYBANK = "SET_NOTMYBANK";
...
export const SET_LIVEMAINTAIN = "SET_LIVEMAINTAIN";
export const SET_ACTIVITY = "SET_ACTIVITY";
export const SET_LIVEFOOTERMASK = "SET_LIVEFOOTERMASK";
export const SET_LIVEFOOTER = "SET_LIVEFOOTER";
export const SET_LIVEVIEWPATH = "SET_LIVEVIEWPATH";
export const SET_BINDFRIEND = "SET_BINDFRIEND";
export const SET_LANDINGINFO = "SET_LANDINGINFO";
