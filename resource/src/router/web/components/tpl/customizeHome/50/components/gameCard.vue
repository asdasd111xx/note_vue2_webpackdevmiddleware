<template>
    <div :class="[$style['middel-container'], 'clearfix']">
        ...
        >
            <div :class="$style['cover-wrap']" :style="{ background: `url('/static/image/tpl/customizeHome/50/img_${card.cover.type}.png') 0 0 no-repeat` }">
                <div :class="$style['img-wrap']">
                    <img :src="$getCdnPath(`/static/image/tpl/customizeHome/50/icon_${card.cover.type}.png`)" />
                </div>
            ...
            <div :class="[$style['link-wrap'], {[$style.center]: index === 1 || index === 2}]">
                ...
                >
                    ...
                    <img :src="$getCdnPath(`/static/image/tpl/customizeHome/50/logo_${links.vendor}.png`)" />
...
.link-wrap {
    ...
    height: 100%;
    padding-top: 20px;
    background: url('/static/image/tpl/customizeHome/50/bg_black.png') 0 0 no-repeat;
    transition: .8s ease-in-out;
    transform: rotateY(180deg) translateZ(0);
}
...
.item {
    ...
    &:hover {
        background: url('/static/image/tpl/customizeHome/50/icon_hover.png') 0 0 no-repeat;
    }
}

.item-line {
    height: 1px;
    background: url('/static/image/tpl/customizeHome/50/icon_xian.png') 0 0 no-repeat;
}
