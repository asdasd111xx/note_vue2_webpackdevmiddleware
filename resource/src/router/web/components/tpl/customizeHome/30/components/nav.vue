...
export default {
    ...
    data() {
        return {
            ...
            navSubTitle: {
                6474: i18nList.navSubLink01,
                5263: i18nList.navSubLink02,
                5227: i18nList.navSubLink03,
                6476: i18nList.navSubLink04,
                5256: i18nList.navSubLink05
            }
        };
    },
    computed: {
