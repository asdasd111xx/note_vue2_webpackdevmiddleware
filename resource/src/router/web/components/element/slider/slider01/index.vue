<template>
    <element-wrap
        ...
        :element="element"
        :theme="['A', 'B', 'C', 'D', 'E']"
        :class="`is-slider01 theme-${element.theme}`"
    >
...
export default {
    ...
    methods: {
        ...
        defaultCase() {
            ...
            const tpl = this.webInfo.model;
            const style = this.webInfo.style_color;
            const fieldData = [];
            let tempData = [];
            let defaultBg = {};
            ...
            if (eleData.data[tpl] && eleData.data[tpl][style]) {
                ...
                defaultBg = eleData.background[tpl][style];
            } else {
                tempData = eleData.data.default;
                defaultBg = eleData.background.default;
            }
            ...
            this.updateField({
                ...
                setting: {
                    ...
                    effect: 'slide',
                    mode: 'dots',
                    'background-color': defaultBg.color,
                    'background-position': defaultBg.position,
                    'background-repeat': defaultBg.repeat,
                    'background-image': defaultBg.image
                }
            });
        },
        updateField(data) {
...
@media screen and (max-width: $pc + $sidebar) {
    .element-wrap /deep/ .slick-wrap.theme-C {
        width: 768px;
        height: 160px;
    }
}

@media screen and (max-width: $pad + $sidebar) {
    .element-wrap /deep/ .slick-wrap.theme-C {
        width: 480px;
        height: 100px;
    }
...
@media screen and (max-width: $phone + $sidebar) {
    .element-wrap /deep/ .slick-wrap.theme-C {
        width: 320px;
        height: 67px;
    }
