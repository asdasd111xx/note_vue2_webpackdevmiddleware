            ...
            <div :class="$style['qrcode-container']">
                <div :class="$style['qrcode-img']">
                    ...
                    <div @click="openMobileBet">
                        <img src="/static/image/tpl/customizeHome/70/body/qrcode_text.png" />
                    </div>
                </div>
                <div :class="$style['qrcode-img']">
                    <img :class="$style.qrcode" :src="mobileBetImage" />
        ...
        <div :class="$style['copy-wrap']">
            <div :class="$style['copy-container']">
                <div :class="$style['copy-text']">
                    <img src="/static/image/tpl/customizeHome/70/body/footer_info.png" />
                </div>
                <div :class="$style['copy-info']">
                    <img :class="$style['copy-info-title']" src="/static/image/tpl/customizeHome/70/body/footer_info_title01.png" />
                    <img :class="$style['img-bbin']" src="/static/image/tpl/customizeHome/70/body/bbin.png" />
                    <img :class="$style['img-gli']" src="/static/image/tpl/customizeHome/70/body/gli.png" />
                </div>
                <div :class="$style['copy-info']">
                    <img :class="$style['copy-info-title']" src="/static/image/tpl/customizeHome/70/body/footer_info_title02.png" />
                    <img :class="$style['img-payment']" src="/static/image/tpl/customizeHome/70/body/footer_info_payment.png" />
                </div>
            </div>
        </div>
    </div>
