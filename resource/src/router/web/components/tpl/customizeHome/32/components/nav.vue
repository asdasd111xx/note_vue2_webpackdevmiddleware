...
export default {
    ...
    data() {
        return {
            ...
            navSubTitle: {
                6470: i18nList.navSubLink01,
                5646: i18nList.navSubLink02,
                5610: i18nList.navSubLink03,
                6370: i18nList.navSubLink04,
                5639: i18nList.navSubLink05
            }
        };
    },
    computed: {
