<template>
    <div :class="$style['forget-password']">
        ...
        >
            <img :src="$getCdnPath('/static/image/mobile/tpl/theme3/login/back_white.png')" />
        </a>
        <forget-pwd
            :username="username"
            :email="email"
                        ...
                        <div :class="$style['user-data']">
                            <div v-if="currentMethod !== 'phoneStatus2' && currentMethod !== 'phoneStatus3'" :class="$style['form-control']">
                                <div class="clearfix">
                                    <div :class="$style['form-icon']">
                                        <img :src="$getCdnPath('/static/image/mobile/tpl/theme3/login/account.png')" />
                                    </div>
                                    <input
                                        v-model="username"
                            ...
                            <div>
                                <div v-if="currentMethod === 'email'" class="clearfix">
                                    <div :class="$style['form-icon']">
                                        <img :src="$getCdnPath('/static/image/mobile/tpl/theme3/login/email.png')" />
                                    </div>
                                    <input
                                        v-model="email"
                            ...
                            <div v-if="currentMethod === 'phoneStatus2'" class="clearfix">
                                <div :class="$style['form-icon']">
                                    <img :src="$getCdnPath('/static/image/mobile/tpl/theme3/login/phone.png')" />
                                </div>
                                <input
                                    v-model="keyring"
...
.forget-password {
    min-height: 100vh;
    padding-top: 130px;
    background: url('/static/image/mobile/tpl/theme3/login/forget-bg.png') no-repeat center;
