...
const PORN1_DOMAIN_QA = 'http://192.168.133.98:8080';
const PORN1_DOMAIN_PROD = 'https://ncpxsgypt.com';
export const PORN1_DOMAIN = process.env.NODE_ENV !== 'development' ? PORN1_DOMAIN_DEV : PORN1_DOMAIN_DEV;
