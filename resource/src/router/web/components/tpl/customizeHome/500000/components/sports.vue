<template>
    <div :class="[$style.container, { [$style['has-coming-soon']]: gameData.csc.switch !== 'Y' }, 'clearfix']">
        <div :class="$style['img-wrap']">
            <img v-if="gameData.csc.switch === 'Y'" :src="$getCdnPath('/static/image/tpl/customizeHome/500000/sports/app_sprite.png')" />
            <img v-else :src="$getCdnPath('/static/image/tpl/customizeHome/500000/sports/comimgsoon.png')" />
        </div>
...
.promotion-img {
    ...
    height: 76px;
    margin: 12px auto 0;
    background: url('/static/image/tpl/customizeHome/500000/sports/icon-50.png') 50% 50% no-repeat;
}
