...
export default {
  components: {
    ...
    editLiveAlias: () =>
      import(/* webpackChunkName: 'editLiveAlias' */ "./form/editLiveAlias"),
    ...
    editHometown: () =>
      import(/* webpackChunkName: 'editHometown' */ "./form/editHometown"),
    editRelationship: () =>
      import(
        /* webpackChunkName: 'editRelationship' */ "./form/editRelationship"
      ),
    DatePicker
  },
  data() {
    ...
    checkAliasEdit() {
      return this.actionGetExtRedirect({
        ...
        if (data && data.result && data.result.allow_update === false) {
          ...
          this.$router.push({
            path: `/mobile/mcenter/accountData/liveAlias`
          });
        }
      });
    },
