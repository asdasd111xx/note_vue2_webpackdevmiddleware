        ...
        <div class="header-content clearfix">
            <div class="header-logo clearfix">
                <div class="header-logo-img">
                    <img :src="$getCdnPath('/static/image/tpl/customizeHome/52/header/logo.png')" @click="actionChangePage({ page: webInfo.page[0].pid, type: 'custom'})" />
                </div>
            </div>
            ...
            <div :class="[{'header-login' : loginStatus}, 'header-nav-right', 'clearfix']">
                ...
                >
                    <div class="nav-right-text">
                        <div class="nav-right-content">
                            <div class="nav-icon">
                                <img :src="$getCdnPath('/static/image/tpl/customizeHome/52/header/login.png')" />
                            </div>
                ...
                <div class="nav-left-item" @click="goMcenterPage('accountData')">
                    <div class="nav-right-text">
                        <div class="nav-right-content">
                            <div class="nav-icon">
                                <img :src="$getCdnPath('/static/image/tpl/customizeHome/52/header/vip.png')" />
                            </div>
                ...
                <div class="nav-left-item">
                    <div class="nav-right-text" @click="actionChangePage({ page: 'mobileBet', type: 'static'})">
                        <div class="nav-right-content">
                            <div class="nav-icon">
                                <img :src="$getCdnPath('/static/image/tpl/customizeHome/52/header/app.png')" />
                            </div>
                ...
                <div class="nav-left-item" @click="actionChangePage({ page: '10684', type: 'custom'})">
                    <div class="nav-right-text">
                        <div class="nav-right-content">
                            <div class="nav-icon">
                                <img :src="$getCdnPath('/static/image/tpl/customizeHome/52/header/promotion.png')" />
                            </div>
