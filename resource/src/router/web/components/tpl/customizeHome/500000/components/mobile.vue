    ...
    <div :class="$style['mobile-wrap']">
        <div :class="$style['img-wrap']">
            <div :class="$style['img-phone2']">
                <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/img_iphone2${currentData === 'sport' ? '_sport' : ''}.png`)" />
            </div>
            <div :class="$style['img-phone3']">
                <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/img_iphone3${currentData === 'sport' ? '_sport' : ''}.png`)" />
            </div>
            <div :class="$style['img-human']">
                <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/img_${currentData === 'sport' ? 'cr7-1' : 'shaizi'}.png`)" />
            </div>
            <div :class="$style['img-player']">
                <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/img_${currentData === 'sport' ? 'messi-1' : 'poker'}.png`)" />
            </div>
            <div :class="$style['img-phone1']">
                <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/img_iphone1${currentData === 'sport' ? '_sport' : ''}.png`)" />
            </div>
        </div>
        <div :class="$style['content-wrap']">
            ...
            <div :class="[$style['download-wrap'], 'clearfix']">
                ...
                <div :class="$style['web-link-wrap']">
                    <img :src="$getCdnPath('/static/image/tpl/customizeHome/500000/h5_icon.png')" />
                    <div :class="$style['download-title']">{{ $text('S_SCAN_DOWNLOAD_APP', '扫码下载APP') }}</div>
