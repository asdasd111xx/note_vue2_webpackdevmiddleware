    ...
    detailData() {
      ...
      switch (this.themeTPL) {
        ...
        case "sg1":
          ...
          // Only 鴨博只有返水比例表格
          data.vipList = [
            ["VIP0", "0.38%", "0.40%", "1.10%", "0.80%", "0.60%", "3.00%"],
            ["VIP1", "0.38%", "0.45%", "1.20%", "0.80%", "0.65%", "3.00%"],
            ["VIP2", "0.38%", "0.45%", "1.30%", "0.90%", "0.70%", "3.00%"],
            ["VIP3", "0.40%", "0.50%", "1.40%", "0.90%", "0.75%", "3.00%"],
            ["VIP4", "0.45%", "0.55%", "1.50%", "1.00%", "0.80%", "3.00%"],
            ["VIP5", "0.45%", "0.60%", "1.60%", "1.00%", "0.85%", "3.00%"],
            ["VIP6", "0.50%", "0.65%", "1.70%", "1.10%", "0.90%", "3.00%"],
            ["VIP7", "0.55%", "0.70%", "1.80%", "1.10%", "0.95%", "3.00%"],
            ["VIP8", "0.68%", "0.75%", "1.90%", "1.20%", "1.00%", "3.00%"],
            ["VIP9", "0.80%", "0.85%", "2.00%", "1.20%", "1.10%", "3.00%"],
            ["VIP10", "1.00%", "1.00%", "2.10%", "1.30%", "1.20%", "3.00%"]
          ];
