<template>
    <div :class="[$style['deposit-wrap'], $style[`theme-${siteConfig.MCENTER_COLOR}`]]">
        <!-- 導覽選單 -->
                    ...
                    <div :class="[$style['feature-wrap'], 'clearfix']">
                        ...
                        <div :class="[$style['bank-feature-wrap']]">
                            <div v-if="!isDepositAi && (Object.keys(curPassRoad).length === 0 || curPassRoad.is_custom_amount)" :class="$style['money-input-wrap']">
                                <input
                                    v-model="moneyValue"
                                    :class="[$style['deposit-input'], { [$style['is-error']]: isErrorMoney }]"
                                ...
                                />
                                <span v-if="isErrorMoney && depositInterval.maxMoney" :class="$style['error-tip']">
