<template>
    <div :class="$style['page-wrap']">
        <div :class="$style['page-container']">
            ...
            >
                <img :class="$style['img-out']" :src="`/static/image/tpl/customizeHome/71/body/first_promotion_item0${num}_over.png`" />
                <img :class="$style['img-in']" :src="`/static/image/tpl/customizeHome/71/body/first_promotion_item0${num}.png`"/>
            </div>
            <img
                :class="$style['add-btn']"
                :src="$getCdnPath('/static/image/tpl/customizeHome/71/body/firtst_promotion_more_btn.png')"
                @click="changePage(promotionData)"
            />
        </div>
    </div>
