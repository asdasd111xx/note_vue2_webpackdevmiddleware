<template>
    <div :class="$style.container">
        ...
        <div :class="$style.content">
            ...
            <div :class="$style.close" @click="onClose">x</div>
            <div :class="$style.form">
                <div :class="$style.field">
                    <div :class="$style['field-title']">{{ checkItemInfo[checkItem].title }}</div>
                    <input
                        v-model="inputVal"
            ...
            <div :class="$style.tip">{{ $text('S_NO_SETTING', '若未设置，请联系线上客服') }}</div>
        </div>
    </div>
</template>
