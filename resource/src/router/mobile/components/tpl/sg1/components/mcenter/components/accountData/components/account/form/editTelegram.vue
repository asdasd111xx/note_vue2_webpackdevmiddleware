  ...
  <div slot="content" :class="$style['content-wrap']">
    ...
    <div :class="[$style.wrap, 'clearfix']">
      ...
      <div :class="$style.block">
        <div :class="$style.title">{{ $text("S_TELEGRAM") }}</div>
        <div :class="$style['input-wrap']">
          <input
            ref="input"
            v-model="value"
            :value="value"
            :placeholder="`请输入${$text('S_TELEGRAM')}`"
            :class="$style.input"
            :maxlength="32"
            type="text"
            @input="onInput"
