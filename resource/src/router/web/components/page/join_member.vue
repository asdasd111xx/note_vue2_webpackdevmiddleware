        ...
        <div :class="$style.join">
            ...
            <div :class="$style['join-content']">
                ...
                >
                    ...
                    <div
                        :class="allTip[field.key] ? $style['join-tip-show'] : $style['join-tip']"
            ...
            <div v-else :class="$style['join-btn-wrap']">
                <div :class="[$style['join-btn'], {[$style.disabled]: !isSlideAble}]" @click="joinSubmit()">
