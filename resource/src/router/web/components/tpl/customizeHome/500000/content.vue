    ...
    <div :class="[$style['content-wrap'],'theme-theme3']">
        <div :class="$style['swiper-wrap']">
            ...
            <div :class="$style['pagination-wrap']">
                <div :class="$style['pagination-container']">
                    ...
                    >
                        <img :src="$getCdnPath(`/static/image/tpl/customizeHome/500000/image${num}.jpg`)" />
                    </div>
                </div>
            </div>
        </div>
        <div :class="$style['news-wrap']">
            ...
            <div :class="$style.service">
                <img :src="$getCdnPath('/static/image/tpl/customizeHome/500000/icon_service.png')" />
...
export default {
    ...
    data() {
        return {
            ...
            swipperList: [
                {
                    image: '/static/image/tpl/customizeHome/500000/image1.jpg',
                    path: ''
                },
                {
                    image: '/static/image/tpl/customizeHome/500000/image2.jpg',
                    path: '/page/32371'
                },
                {
                    image: '/static/image/tpl/customizeHome/500000/image3.jpg',
                    path: '/page/32371'
                },
                {
                    image: '/static/image/tpl/customizeHome/500000/image4.jpg',
                    path: ''
                },
                {
                    image: '/static/image/tpl/customizeHome/500000/image5.jpg',
                    path: 'mobileBet'
                },
                {
                    image: '/static/image/tpl/customizeHome/500000/image6.jpg',
                    path: ''
                }
            ],
            realIndex: 0
...
.news-title {
    ...
    width: 182px;
    padding-left: 35px;
    background: url('/static/image/tpl/customizeHome/500000/message.png') 0 50% no-repeat;
    vertical-align: top;
}
