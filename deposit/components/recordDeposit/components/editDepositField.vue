            ...
            <div :class="$style['alert-wrap']">
                ...
                <div :class="$style['alert-body-wrap']">
                    <div :class="$style['deposit-info-table']">
                        <div :class="$style['deposit-info-tr']">
                        ...
                        <div :class="$style['deposit-info-tr']">
                            ...
                            <div :class="$style['deposit-info-td']">{{ depositData.submit_at || `${$text('S_NOT_ENTER_SHORT', '尚未提交')}（ ${$text('S_RECORD_TIP01', '将以您最后提交时的存款资料做审核')} )` }}</div>
                        </div>
                    </div>
...
<style lang="scss" src="../css/editDepositField.scss" module></style>
