            ...
            <div :class="$style['service-header']">
                <div :class="$style['btn-prev']" @click="$router.back()">
                    <img
                        :src="
                            $getCdnPath(
                                '/static/image/_new/common/btn_back_w.png'
                            )
                        "
                    />
                </div>
            ...
            <div :class="$style['info-card']" @click="clickService">
                <div>
                    <div>
                        <img
                            :src="
                                $getCdnPath(
                                    `/static/image/_new/service/ic_service01.png`
                                )
                            "
                        />
                        &nbsp;
                ...
                <div :class="$style['btn-next']">
                    <img
                        :src="
                            $getCdnPath(
                                `/static/image/_new/common/btn_next.png`
                            )
                        "
                    />
                </div>
                ...
                <div>
                    <div>
                        <img
                            :src="
                                $getCdnPath(
                                    `/static/image/_new/service/ic_service02.png`
                                )
                            "
                        />
                        &nbsp;
            ...
            <div :class="$style['tip-block']" @click="clickPopTip">
                <div :class="$style['tip-img']">
                    <img
                        :src="
                            $getCdnPath(
                                `/static/image/_new/service/appicon_yabo.png`
                            )
                        "
                    />
                </div>
