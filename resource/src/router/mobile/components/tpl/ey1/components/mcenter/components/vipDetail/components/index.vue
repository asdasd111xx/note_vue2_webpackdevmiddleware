    ...
    <div :class="$style['table-container']">
      ...
      <div :class="$style['table-wrap']">
        <div :class="$style['table-header']">
          ...
          <div :class="$style['header-item']">累积<br />投注</div>
...
export default {
  ...
  data() {
    return {
      ...
      // ],
      list: [
        ["VIP10", "1.25亿", "10亿", "1,100万", "100万", "9,000", "1.5万"],
        ["VIP9", "6,250万", "5亿", "500万", "50万", "5,000", "7,000"],
        ["VIP8", "1,875万", "1.5亿", "100万", "15.5万", "1,500", "2,000"],
        ["VIP7", "250万", "2,000万", "20万", "1.88万", "200", "-"],
        ["VIP6", "75万", "600万", "6万", "5,000", "60", "-"],
        ["VIP5", "12.5万", "100万", "1万", "1,000", "10", "-"],
        ["VIP4", "1.25万", "10万", "1,000", "120", "-", "-"],
        ["VIP3", "2,500", "2万", "200", "50", "-", "-"],
        ["VIP2", "750", "6,000", "60", "20", "-", "-"],
        ["VIP1", "250", "2,000", "20", "10", "-", "-"],
        ["VIP0", "-", "-", "-", "-", "-", "-"]
      ]
    };
  },
      ...
      let list = [
        {
          ...
          title: "晋级标准",
          content:
            "累积全产品总有效投注达相对应级别门槛，即可晋级相对应的VIP等级。<br />等级更新时间：北京时间每日下午4点"
        },
        {
          number: "❷",
          title: "晋级顺序",
          content: "VIP等级达要求门槛即可晋级，并可越级晋级。"
        },
        {
          number: "❸",
          title: "保级要求",
