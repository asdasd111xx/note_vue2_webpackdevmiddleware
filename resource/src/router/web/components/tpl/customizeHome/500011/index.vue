                        ...
                        <div class="carousel-banner">
                            ...
                            <div class="pagination-wrap">
                                <div class="page-button button-prev active">
                                    <img :src="$getCdnPath('/static/image/tpl/customizeHome/500011/slide-back.png')" class="button-prev-img" />
                                </div>
                                <div class="swiper-pagination" />
                                <div class="page-button button-next">
                                    <img :src="$getCdnPath('/static/image/tpl/customizeHome/500011/slide-next.png')" class="button-next-img" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            slideImg: [
                {
                    ...
                    img: '/static/image/tpl/customizeHome/500011/slide01.png'
                },
                {
                    link: 'https://iledong.com/activity-first-save',
                    img: '/static/image/tpl/customizeHome/500011/slide02.png'
                }
            ],
...
.home-banner-box {
    ...
    position: fixed;
    top: 95px;
    background: url('/static/image/tpl/customizeHome/500011/banner.jpg') center no-repeat;
}
...
.top-wrap {
    ...
    position: relative;
    z-index: 5;
    background: url('/static/image/tpl/customizeHome/500011/bg01.png') #000 no-repeat bottom center;
...
.swiper-banner-link {
    ...
    margin-left: 15px;
    cursor: pointer;
    background: url('/static/image/tpl/customizeHome/500011/slide-bg01.png') no-repeat center #000;
    z-index: 2;
...
.year-turnover {
    background: url('/static/image/tpl/customizeHome/500011/text-bg01.png') no-repeat center bottom;
    width: 1200px;
    height: 55px;
    line-height: 1;
    margin: 0 auto 80px;
...
.access-amount-item{
    ...
    height: 39px;
    line-height: 39px;
    background: url('/static/image/tpl/customizeHome/500011/text-bg02.png') no-repeat center bottom;
    text-align: center;
    font-size: 15px;
...
.advantage-item-img1 {
    background-image: url('/static/image/tpl/customizeHome/500011/item01.png');
}

.advantage-item-img2 {
    background-image: url('/static/image/tpl/customizeHome/500011/item02.png');
}

.advantage-item-img3 {
    background-image: url('/static/image/tpl/customizeHome/500011/item03.png');
}
