  ...
  <div class="ui fluid form">
    ...
    >
      ...
      >
        <div
          v-if="
            caseData.key[curLang] === 'name' && caseData.state[curLang] === 'Y'
          "
        ...
        >
          ...
          <div
            ...
            class="ui pointing red basic label"
          >
            {{ $text('S_FORM_ACCOUNT_ERROR', { text:
            '请输入4-20位英文小写、数字，首字不得为数字', replace: [{ target:
            '%s', value: '<br />'}] }) }}
          </div>
        </div>
        <div
          v-if="
            caseData.key[curLang] === 'phone' && caseData.state[curLang] === 'Y'
          "
          class="field element clearfix"
        >
          <input
        ...
        <div
          v-if="
            caseData.key[curLang] === 'email' && caseData.state[curLang] === 'Y'
          "
          class="field element clearfix"
        >
          ...
          <div
            ...
            class="ui pointing red basic label"
            v-html="
              $text('S_JM_EMAIL_FORMAT_UNAVAILABLE', {
                text: 'E-mail 格式不正确',
                replace: [
                  {
                    target: '%s',
