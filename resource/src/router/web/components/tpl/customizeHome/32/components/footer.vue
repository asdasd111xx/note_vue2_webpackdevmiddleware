    ...
    <div class="footer-wrap">
        <div class="footer">
                    ...
                    <div class="introduction-left-btn">
                        <span
                            @click="changePage({
                                page: 'promotion',
                                type: 'static',
                                config: { linkItem: '7ec69c696b45d7ba72e14f6d99a421608cfaf88a' }
                            })"
                        >
            ...
            <div class="footer-introduction-img">
                <img :src="$getCdnPath('/static/image/tpl/customizeHome/32/bbin.png')" class="bbin" />
                <img
                    :src="$getCdnPath('/static/image/tpl/customizeHome/32/ublogo.png')"
                    class="ubb"
