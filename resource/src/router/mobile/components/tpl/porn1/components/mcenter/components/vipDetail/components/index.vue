...
export default {
  ...
  data() {
    return {
      ...
      list: [
        ["VIP0", "0.3%", "0.3%", "0.3%", "2.0%", "1.0%"],
        ["VIP1", "0.4%", "0.4%", "0.4%", "2.1%", "1.1%"],
        ["VIP2", "0.5%", "0.5%", "0.5%", "2.2%", "1.2%"],
        ["VIP3", "0.6%", "0.6%", "0.6%", "2.3%", "1.3%"],
        ["VIP4", "0.7%", "0.7%", "0.7%", "2.4%", "1.4%"],
        ["VIP5", "0.8%", "0.8%", "0.8%", "2.5%", "1.5%"],
        ["VIP6", "0.9%", "0.9%", "0.9%", "2.6%", "1.6%"],
        ["VIP7", "1.0%", "1.0%", "1.0%", "2.7%", "1.7%"],
        ["VIP8", "1.1%", "1.1%", "1.1%", "2.8%", "1.8%"],
        ["VIP9", "1.2%", "1.2%", "1.2%", "2.9%", "1.9%"],
        ["VIP10", "1.3%", "1.3%", "1.3%", "3.0%", "2.0%"]
      ]
    };
  },
  computed: {
...
<style lang="scss" src="@/css/page/vipDetail/porn1.index.scss" module="$style_porn1"></style>
<style lang="scss" src="@/css/page/vipDetail/ey1.index.scss" module="$style_ey1"></style>
