                        ...
                        <template v-if="!nowEditAddress.includes(item.id)">
                            ...
                            <div class="address-table-type">
                                ...
                                <div v-else class="address-operate">
                                    <button @click="setEditData(item)"><icon class="btn-icon" name="edit" /></button>
                                    <button @click="nowDeleteAddress = item.id"><icon class="btn-icon" name="trash-alt" /></button>
                                </div>
                            </div>
                        </template>
                        <template v-else>
                            <div class="address-table-type">
                                ...
                                <div class="address-input mobile">
                                    ...
                                    <select v-model="editData[key].countryCode" :class="['add-select', item.tips.countryCode ? 'notice' : '']">
                                        <option v-for="(code, codeKey) in openCountryCode" :key="`country-code-${codeKey}`">{{ code }}</option>
                                    </select>
                                    <input
...
<script>
import receiptAddress from '@/components/common/agent/receiptAddress';
