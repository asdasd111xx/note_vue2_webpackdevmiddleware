    ...
    <div :class="$style['header-wrap']" :style="{ left: `${distance}px` }">
        ...
        <div :class="$style['header-middle']">
            <div :class="$style['middle-wrap']">
                ...
                <img :src="$getCdnPath('/static/image/tpl/customizeHome/48/logo.png')" @click="changePage(homeLink)" />
                <div
...
.nav {
    ...
    &:hover {
        ...
        .icon {
            ...
            background: url('/static/image/tpl/customizeHome/48/ico_arrow_up.png') 0 50% no-repeat;
        }
...
.icon {
    ...
    width: 12px;
    height: 8px;
    background: url('/static/image/tpl/customizeHome/48/ico_arrow_down.png') 0 0 no-repeat;
