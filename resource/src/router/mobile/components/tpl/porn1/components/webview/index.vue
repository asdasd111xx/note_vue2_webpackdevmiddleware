        ...
        <div :class="$style['info-card']" @click="clickService">
            <div>
                <div>
                    <img
                        :src="
                            $getCdnPath(
                                `/static/image/_new/webview/ic_service01.png`
                            )
                        "
                    />
                    &nbsp;
            ...
            <div :class="$style['btn-next']">
                <img
                    :src="
                        $getCdnPath(
                            `/static/image/_new/webview/ic_service_arrow.png`
                        )
                    "
                />
            </div>
            ...
            <div>
                <div>
                    <img
                        :src="
                            $getCdnPath(
                                `/static/image/_new/webview/ic_service02.png`
                            )
                        "
                    />
                    &nbsp;
...
.header {
    position: relative;
    background: url("/static/image/_new/webview/bg_service_app.png") center
